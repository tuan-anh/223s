      ...
      real co32(70,360,360),co65(43,432,432),fco(2,250,40)
c
...
ccc            call hf2(30,float(i)-.5,float(j)-.5,sco65/sco321)
            
            if(i.gt.4.and.i.lt.45.and.j.gt.4.and.j.lt.45)then
               call hf2(30,float(i)-.5,float(j)-.5,sco65/sco32)
               if(abs(sco65/sco32).gt.2.5)then
                  print*,'prob: ',i,j,sco65,sco32,sco65/sco32
               endif
            endif
